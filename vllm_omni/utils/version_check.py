    ...
    try:
        ...
        if vllm_major != omni_major:
            msg = (
                ...
                f"  - For vLLM {vllm_major[0]}.{vllm_major[1]}.x: "
                f"pip install vllm~={vllm_major[0]}.{vllm_major[1]}.0\n"
                f"  - For vLLM-Omni {omni_major[0]}.{omni_major[1]}.x: "
                f"pip install vllm-omni~={omni_major[0]}.{omni_major[1]}.0\n"
                f"\n"
